...
public class StoreController {
    ...
    @GetMapping(path = "/ventasXCantidad/{i}")
    public ResponseEntity<ResponseDTO> ventasXCantidad(@PathVariable int i) {
        return new ResponseEntity<>(new ResponseDTO(200, storeService.ventasXCantidad(1), null), HttpStatus.OK);
    }
